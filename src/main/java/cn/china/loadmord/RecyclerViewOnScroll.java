...
public class RecyclerViewOnScroll extends RecyclerView.OnScrollListener {
    ...
    private PullLoadMoreRecyclerView.MyononScrolled  myononScrolled;
    ...
    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
        ...
        if (myononScrolled!=null){
            myononScrolled.onScrolled( recyclerView, dx,  dy);
        }
    ...
    public void setMyononScrolled(PullLoadMoreRecyclerView.MyononScrolled listener) {
