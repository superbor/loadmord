...
public class PullLoadMoreRecyclerView extends LinearLayout {
    ...
    private  MyononScrolled myononScrolled;
    public PullLoadMoreRecyclerView(Context context) {
        super(context);
        initView(context);
    }
    public PullLoadMoreRecyclerView(Context context,MyononScrolled myononScrolled ) {
        super(context);
        myononScrolled =myononScrolled;
        initView(context);
    }
    ...
    private void initView(Context context) {
        mContext = context;
         view = LayoutInflater.from(context).inflate(cn.china.loadmord.R.layout.pull_loadmore_layout, null);
    ...
    public void setHeadLayout(View headview) {

        LinearLayout father =(LinearLayout) view.findViewById(R.id.loadmore_father);

        father.addView(headview);
    }
    /**
     * LinearLayoutManager
     */
  ...
  //必须设置
    public void setMyononScrolled(MyononScrolled listener) {
        myononScrolled = listener;
        RecyclerViewOnScroll onScroll =new RecyclerViewOnScroll(this);

        if (myononScrolled!=null){
            onScroll.setMyononScrolled(myononScrolled);
        }
    ...
    public interface MyononScrolled {
